...
public class ToolboxPanel extends JPanel implements ActionListener{
    ...
    private Label lb_color = new Label("     Colors", Label.LEFT);  // colors 글씨 라벨 만들기
	...
	public ToolboxPanel() {
    	...
    	center_Pn.add(color_Pn=new JPanel(),BorderLayout.CENTER);//좌측에 색상버튼을 올리기 위한 panel
    ...
    public void actionPerformed(ActionEvent e) {
    	...
    	if (e.getSource() == btn_black) {
        	...
        	CanvasPanel.color = Color.LIGHT_GRAY;
