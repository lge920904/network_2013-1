...
public class RoomListTool {
	...
	public JPanel createRoom(String roomName) {
		...
		room.setPreferredSize(new Dimension(270,160));
		room.setBackground(Color.BLACK);
		room.add(new JLabel(roomName));
		totalRoomNum ++;
		roomList.add(room);

		if(totalRoomNum == (maxRoomNum*currentPage)+1){
			createPage();
		}
	...
	public void createPage(){
		page = new JPanel();
		page.setPreferredSize(new Dimension(Constants.PANELS_RIGHT_WIDTH,670));
