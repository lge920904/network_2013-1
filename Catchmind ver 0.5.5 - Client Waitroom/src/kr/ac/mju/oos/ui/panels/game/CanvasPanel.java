...
public class CanvasPanel extends JPanel {
	...
	public void setGraphics() {
		...
		System.out.println("setGraphics 2");
		drawingTool.setGraphics(g2D);
		System.out.println("setGraphics end");
	}
	...
	public void serverDrawing(ArrayList<Point> points) {
		System.out.println("CanvasPanel ServerDrawing");
		this.setGraphics();
		System.out.println("CanvasPanel ServerDrawing - SetGraphics");
