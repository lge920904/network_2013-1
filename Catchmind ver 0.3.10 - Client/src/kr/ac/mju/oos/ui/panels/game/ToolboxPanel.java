...
//	private Setting setting;
	...
	//private JSlider slider = new JSlider(1, 50, pointSize);
	...
	private JButton btn_color = new JButton("edit"); // 캔버스초기화 버튼
	private JButton btn_new = new JButton("C L E A R"); // 캔버스초기화 버튼
	private JButton btn_exit = new JButton("방 나가기"); // 게임방나가기 버튼
	...
	public ToolboxPanel() {
		...
		//setting
		setting.setThickList(btn_1);
		setting.setThickList(btn_2);
		setting.setThickList(btn_3);
		setting.setThickList(btn_4);
		setting.setThickList(btn_5);
		...
		color_Pn.add(btn_color);
		color_Pn.add(btn_new);
		color_Pn.add(btn_exit);
	...
	public void setBrushSize(String currentBrush, int size){
		if(btn_1.getActionCommand().equals(currentBrush)){
			th1=size;
		}else if(btn_2.getActionCommand().equals(currentBrush)){
			th1=size;
		}else if(btn_3.getActionCommand().equals(currentBrush)){
			th1=size;
		}else if(btn_4.getActionCommand().equals(currentBrush)){
			th1=size;
		}else if(btn_5.getActionCommand().equals(currentBrush)){
			th1=size;
		}
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == btn_black) {
			...
			drawTool.setColor(Color.WHITE);
			 ...
			 drawTool.setColor(chooser.showDialog(this,"색상을 고르세요",Color.black));
